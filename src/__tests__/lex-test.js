...
describe('lex()', () => {
  ...
  it('recognizes complex combinations of tokens', () => {
    ...
    expect(lex(input)).toEqual([
      ...
      {content: ' ', position: 228, type: 'WHITESPACE'},
      ...
      {content: ' ', position: 246, type: 'WHITESPACE'},
      ...
      {content: '## ', position: 267, type: 'SUB_HEADING'},
  ...
  describe('regression tests', () => {
    ...
    it('ignores whitespace after CODE tokens', () => {
      // Used to slurp it up and include it with the CODE token, but we ended up
      // teaching the lexer to ignore whitespace, except inside PRE_FENCE
      // blocks.
